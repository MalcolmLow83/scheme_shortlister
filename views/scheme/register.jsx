    ...
    return (
        <Default>
          ...
          <form action="/register" method="POST">
              <p>Your User Account Name:<input type="text" name="name" placeholder="text" required/></p>
              <p>Your User Account Password:<input type="password" name="password" placeholder="text" required/></p>

              <h5>Personal Details</h5>
              <p>Date of Birth:<input type="date" name="birth_date" placeholder="yyyymmdd" required/></p>
              ...
              <p>Year Graduated:<input type="number" name="grad_year" placeholder="yyyy" required/></p>
              ...
              <p>Years of Experience:<input type="number" name="experience" value="0" placeholder="yy"/></p>
              <input type="submit"/>
